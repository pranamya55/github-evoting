...
public class BallotBoxService {
	...
	public boolean existsForElectionEventId(final String ballotBoxId, final String electionEventId) {
		...
		if (!ballotBoxRepository.existsById(ballotBoxId)) {
			return false;
		}
		final String ballotBoxElectionEventId = getBallotBoxByBallotBoxId(ballotBoxId).getVerificationCardSetEntity().getElectionEventEntity()
				.getElectionEventId();

 ...
 */
export type ShortChoiceReturnCode = VoteShortChoiceReturnCode | ElectionShortChoiceReturnCode;
export type ElectionShortChoiceReturnCode = ListShortChoiceReturnCode | CandidateShortChoiceReturnCode;

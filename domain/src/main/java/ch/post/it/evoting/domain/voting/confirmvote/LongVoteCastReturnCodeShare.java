...
public record LongVoteCastReturnCodeShare(String electionEventId,
										  String verificationCardSetId,
										  String verificationCardId,
										  int nodeId,
										  GqElement longVoteCastReturnCodeShare) implements HashableList {

	public LongVoteCastReturnCodeShare {

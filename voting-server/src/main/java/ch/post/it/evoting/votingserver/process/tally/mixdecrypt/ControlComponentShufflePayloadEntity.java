...
@Table(name = "CONTROL_COMPONENT_SHUFFLE_PAYLOAD")
public class ControlComponentShufflePayloadEntity {
	...
	private ImmutableByteArray shufflePayload;

	@Version
	private int changeControlId;

	protected ControlComponentShufflePayloadEntity() {
		// No-argument constructor to keep JPA happy.
	}

	public ControlComponentShufflePayloadEntity(final String electionEventId, final String ballotBoxId, final int nodeId,
			final ImmutableByteArray shufflePayload) {
	...
	public ImmutableByteArray getShufflePayload() {

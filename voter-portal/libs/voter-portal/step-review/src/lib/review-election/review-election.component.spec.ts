...
import { ReviewElectionComponent } from './review-election.component';
...
describe('ReviewElectionComponent', () => {
	let component: ReviewElectionComponent;
	let fixture: ComponentFixture<ReviewElectionComponent>;
	...
	beforeEach(async () => {
		...
		fixture = TestBed.createComponent(ReviewElectionComponent);
